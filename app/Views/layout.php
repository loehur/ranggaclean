...
<head>
  ...
  <meta name="viewport" content="width=410px, user-scalable=no">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <span class="btn btn-sm btn-secondary"> <i class="fas fa-user-circle"></i> <?= $this->nama_user . " #" . $this->id_laundry . "-" . $this->id_cabang ?></span>
          </div>
        </div>
        ...
        <nav>
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($this->id_privilege == 100 || $this->id_privilege == 101) { ?>
              ...
              <?php if (strpos($title, 'Diskon') !== FALSE) {
                    echo 'active';
                  } ?>">
                  ...
                  <li class="nav-item">
                    <a href="<?= $this->BASE_URL ?>SetDelivery/i/5" class="nav-link 
              <?php if ($title == 'Tarif Delivery') {
                    echo 'active';
                  } ?>">
